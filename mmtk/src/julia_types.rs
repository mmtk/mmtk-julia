...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _jl_module_using"][::std::mem::size_of::<_jl_module_using>() - 24usize];
    ["Alignment of _jl_module_using"][::std::mem::align_of::<_jl_module_using>() - 8usize];
    ["Offset of field: _jl_module_using::mod_"]
        [::std::mem::offset_of!(_jl_module_using, mod_) - 0usize];
    ["Offset of field: _jl_module_using::min_world"]
        [::std::mem::offset_of!(_jl_module_using, min_world) - 8usize];
    ["Offset of field: _jl_module_using::max_world"]
        [::std::mem::offset_of!(_jl_module_using, max_world) - 16usize];
};
#[repr(C)]
#[derive(Debug)]
