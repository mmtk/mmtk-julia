...
#[test]
fn bindgen_test_layout_mmtk__jl_binding_partition_t() {
    const UNINIT: ::std::mem::MaybeUninit<mmtk__jl_binding_partition_t> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<mmtk__jl_binding_partition_t>(),
        40usize,
        concat!("Size of: ", stringify!(mmtk__jl_binding_partition_t))
    );
    assert_eq!(
        ::std::mem::align_of::<mmtk__jl_binding_partition_t>(),
        8usize,
        concat!("Alignment of ", stringify!(mmtk__jl_binding_partition_t))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).restriction) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(mmtk__jl_binding_partition_t),
            "::",
            stringify!(restriction)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).min_world) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(mmtk__jl_binding_partition_t),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_world) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(mmtk__jl_binding_partition_t),
...
fn bindgen_test_layout_mmtk_jl_ucontext_t() {
    const UNINIT: ::std::mem::MaybeUninit<mmtk_jl_ucontext_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
