...
extern "C" {
    pub fn getcontext(__ucp: *mut ucontext_t) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn setcontext(__ucp: *const ucontext_t) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn swapcontext(__oucp: *mut ucontext_t, __ucp: *const ucontext_t) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn makecontext(
...
fn bindgen_test_layout_mmtk__jl_tls_states_t() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ctx_at_the_time_gc_started) as usize - ptr as usize },
        13448usize,
        concat!(
            "Offset of field: ",
            stringify!(mmtk__jl_tls_states_t),
            "::",
            stringify!(ctx_at_the_time_gc_started)
        )
    );
}
