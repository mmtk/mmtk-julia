...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _jl_tls_states_t"][::std::mem::size_of::<_jl_tls_states_t>() - 2448usize];
    ...
    ["Offset of field: _jl_tls_states_t::defer_signal"]
        [::std::mem::offset_of!(_jl_tls_states_t, defer_signal) - 1976usize];
    ["Offset of field: _jl_tls_states_t::current_task"]
        [::std::mem::offset_of!(_jl_tls_states_t, current_task) - 1984usize];
    ["Offset of field: _jl_tls_states_t::next_task"]
        [::std::mem::offset_of!(_jl_tls_states_t, next_task) - 1992usize];
    ["Offset of field: _jl_tls_states_t::previous_task"]
        [::std::mem::offset_of!(_jl_tls_states_t, previous_task) - 2000usize];
    ["Offset of field: _jl_tls_states_t::root_task"]
        [::std::mem::offset_of!(_jl_tls_states_t, root_task) - 2008usize];
    ["Offset of field: _jl_tls_states_t::timing_stack"]
        [::std::mem::offset_of!(_jl_tls_states_t, timing_stack) - 2016usize];
    ["Offset of field: _jl_tls_states_t::stackbase"]
        [::std::mem::offset_of!(_jl_tls_states_t, stackbase) - 2024usize];
    ["Offset of field: _jl_tls_states_t::stacksize"]
        [::std::mem::offset_of!(_jl_tls_states_t, stacksize) - 2032usize];
    ["Offset of field: _jl_tls_states_t::sig_exception"]
        [::std::mem::offset_of!(_jl_tls_states_t, sig_exception) - 2040usize];
    ["Offset of field: _jl_tls_states_t::bt_data"]
        [::std::mem::offset_of!(_jl_tls_states_t, bt_data) - 2048usize];
    ["Offset of field: _jl_tls_states_t::bt_size"]
        [::std::mem::offset_of!(_jl_tls_states_t, bt_size) - 2056usize];
    ["Offset of field: _jl_tls_states_t::profiling_bt_buffer"]
        [::std::mem::offset_of!(_jl_tls_states_t, profiling_bt_buffer) - 2064usize];
    ["Offset of field: _jl_tls_states_t::signal_request"]
        [::std::mem::offset_of!(_jl_tls_states_t, signal_request) - 2072usize];
    ["Offset of field: _jl_tls_states_t::io_wait"]
        [::std::mem::offset_of!(_jl_tls_states_t, io_wait) - 2076usize];
    ["Offset of field: _jl_tls_states_t::signal_stack"]
        [::std::mem::offset_of!(_jl_tls_states_t, signal_stack) - 2080usize];
    ["Offset of field: _jl_tls_states_t::signal_stack_size"]
        [::std::mem::offset_of!(_jl_tls_states_t, signal_stack_size) - 2088usize];
    ["Offset of field: _jl_tls_states_t::system_id"]
        [::std::mem::offset_of!(_jl_tls_states_t, system_id) - 2096usize];
    ["Offset of field: _jl_tls_states_t::suspend_count"]
        [::std::mem::offset_of!(_jl_tls_states_t, suspend_count) - 2104usize];
    ["Offset of field: _jl_tls_states_t::finalizers"]
        [::std::mem::offset_of!(_jl_tls_states_t, finalizers) - 2112usize];
    ["Offset of field: _jl_tls_states_t::previous_exception"]
        [::std::mem::offset_of!(_jl_tls_states_t, previous_exception) - 2368usize];
    ["Offset of field: _jl_tls_states_t::locks"]
        [::std::mem::offset_of!(_jl_tls_states_t, locks) - 2376usize];
    ["Offset of field: _jl_tls_states_t::engine_nqueued"]
        [::std::mem::offset_of!(_jl_tls_states_t, engine_nqueued) - 2440usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _jl_task_t"][::std::mem::size_of::<_jl_task_t>() - 216usize];
    ...
    ["Offset of field: _jl_task_t::fenv"][::std::mem::offset_of!(_jl_task_t, fenv) - 104usize];
    ["Offset of field: _jl_task_t::tid"][::std::mem::offset_of!(_jl_task_t, tid) - 136usize];
    ["Offset of field: _jl_task_t::threadpoolid"]
        [::std::mem::offset_of!(_jl_task_t, threadpoolid) - 138usize];
    ["Offset of field: _jl_task_t::reentrant_timing"]
        [::std::mem::offset_of!(_jl_task_t, reentrant_timing) - 139usize];
    ["Offset of field: _jl_task_t::gcstack"]
        [::std::mem::offset_of!(_jl_task_t, gcstack) - 144usize];
    ["Offset of field: _jl_task_t::world_age"]
        [::std::mem::offset_of!(_jl_task_t, world_age) - 152usize];
    ["Offset of field: _jl_task_t::ptls"][::std::mem::offset_of!(_jl_task_t, ptls) - 160usize];
    ["Offset of field: _jl_task_t::excstack"]
        [::std::mem::offset_of!(_jl_task_t, excstack) - 168usize];
    ["Offset of field: _jl_task_t::eh"][::std::mem::offset_of!(_jl_task_t, eh) - 176usize];
    ["Offset of field: _jl_task_t::ctx"][::std::mem::offset_of!(_jl_task_t, ctx) - 184usize];
};
